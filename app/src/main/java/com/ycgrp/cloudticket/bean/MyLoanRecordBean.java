...
public class MyLoanRecordBean {
    ...
    public static class DataBeanXX {
         ...
         * id : 89
         * type : loan
         * attributes : {"amount":"1621.0","date_of_issue":"2018-11-07","maturity_date":null,"status":"waiting_for_review"}
         * relationships : {"loanee":{"data":{"id":"30","type":"user"}},"guarantor":{"data":{"id":"4","type":"user"}},"bill":{"data":null}}
         */
